...
PDF_PATH = BASE / "24_kakomonn_zaimu.pdf"
OUTPUT_PATH = BASE / "24_kakomonn_zaimu_pdf_game.xlsx"
...
def collect_starts(reader: PdfReader, marker: str) -> dict[int, int]:
    starts: dict[int, int] = {}
...
def build_workbook() -> None:
    ...
    for prefix, _label, table_page in YEARS:
        ...
        question_starts = collect_starts(reader, f"{prefix}財務 問")
        answer_starts = collect_starts(reader, f"{prefix}年財務 解答")
        total += len(question_starts)
